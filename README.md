...
- [Git](https://git-scm.com/) - Version control system (if you want to clone the repository).
...
- And many other dependencies, as listed in the [package.json](package.json) file.
